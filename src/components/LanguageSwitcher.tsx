  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="inline-flex items-center justify-center w-full rounded-xl border border-gray-300 glassmorphism px-2 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-cyan-500"
      >
